...
export const createPromotion = async (req, res) => {
  ...
  try {
    ...
    res
      ...
      .json({ message: "Tạo promotion thất bại", error });
  }
};
...
export const getPromotions = async (req, res) => {
  try {
    ...
    res
      ...
      .json({ message: "Lấy danh sách promotion thất bại", error });
  }
};
...
export const getPromotionById = async (req, res) => {
  ...
  try {
    ...
    res
      .status(StatusCodes.INTERNAL_SERVER_ERROR)
      .json({ message: "Lấy promotion thất bại", error });
  }
};
...
export const updatePromotion = async (req, res) => {
  ...
  try {
    ...
    res
      .status(StatusCodes.BAD_REQUEST)
      .json({ message: "Cập nhật promotion thất bại", error });
  }
};
...
export const deletePromotion = async (req, res) => {
  ...
  try {
    ...
    res
      .status(StatusCodes.INTERNAL_SERVER_ERROR)
      .json({ message: "Xóa promotion thất bại", error });
  }
};
